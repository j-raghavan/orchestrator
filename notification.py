...
if __name__ == "__main__":
    ...
    client.from_email = "YOUR_EMAIL"
    client.password = "YOUR_EMAIL_PASSWORD"

    # For SendGrid
    # client = SMTPClient("sendgrid")
    client.sendgrid_api_key = "YOUR_SENDGRID_API_KEY"

    # For AWS SES
    # client = SMTPClient("aws_ses")
    client.aws_access_key_id = "YOUR_AWS_ACCESS"
    client.aws_secret_access_key = "YOUR_AWS_SECRET"
    client.region_name = "YOUR_AWS_REGION"

    client.send_email(
        "recipient@example.com",
        "Test Subject",
        "Test Body",
        "path/to/attachment.tar.gz",
    )